 ...
 * @author LENOVO
 */
public class chiTietDoanhThuDoAn extends javax.swing.JFrame {

    /**
     * Creates new form chiTietDoanhThuDoAn
     */
    public chiTietDoanhThuDoAn() {
        initComponents();
    ...
    private JPanel createDoanhThuCard(String tenDoAn, int soLuong, double doanhThu) {
        ...
        JLabel lblTenDoAn = new JLabel("Đồ ăn: " + tenDoAn);
        JLabel lblDaBan = new JLabel("Đã bán: " + soLuong);
        JLabel lblDoanhThu = new JLabel("Doanh thu: " + String.format("%,.0f VND", doanhThu));
    ...
    private void loadThongKe() {
        try {
            ...
            // Tổng doanh thu
            String sqlTongDoanhThu = "SELECT SUM(tongTien) as tongDoanhThu FROM hoaDonDoAn";
            ...
            // Tổng số lượng đồ ăn bán ra
            String sqlTongDoAn = "SELECT SUM(soLuong) as tongDoAn FROM chiTietHoaDonDoAn";
            PreparedStatement pstmtTongDoAn = conn.prepareStatement(sqlTongDoAn);
            ResultSet rsTongDoAn = pstmtTongDoAn.executeQuery();
            int tongDoAn = rsTongDoAn.next() ? rsTongDoAn.getInt("tongDoAn") : 0;
            lblTongDoAn.setText(String.valueOf(tongDoAn));

            // Đồ ăn bán được nhiều nhất
            String sqlDoAnNhieuNhat = "SELECT TOP 1 da.tenDoAn, SUM(ct.soLuong) as soLuong "
                    + "FROM chiTietHoaDonDoAn ct JOIN banDoAn da ON ct.maDoAn = da.maDoAn "
                    + "GROUP BY da.tenDoAn ORDER BY soLuong DESC";
            PreparedStatement pstmtDoAnNhieuNhat = conn.prepareStatement(sqlDoAnNhieuNhat);
            ResultSet rsDoAnNhieuNhat = pstmtDoAnNhieuNhat.executeQuery();
            String doAnNhieuNhat = rsDoAnNhieuNhat.next() ? rsDoAnNhieuNhat.getString("tenDoAn") : "Không có";
            lblDoAnNhieuNhat.setText(doAnNhieuNhat);
            ...
            String sqlThangCaoNhat = "SELECT TOP 1 MONTH(ngayMua) as thang, YEAR(ngayMua) as nam, SUM(tongTien) as doanhThu "
                    + "FROM hoaDonDoAn GROUP BY MONTH(ngayMua), YEAR(ngayMua) ORDER BY doanhThu DESC";
            ...
            String sqlDoanhThuTB = "SELECT AVG(tongTien) as doanhThuTB FROM hoaDonDoAn";
    ...
    public void loadDoanhThuCards() {
        try {
            Connection conn = ConnectDB.getConnection();
            String sql = "SELECT da.tenDoAn, SUM(ct.soLuong) as soLuong, SUM(ct.soLuong * da.giaDoAn) as doanhThu "
                    + "FROM chiTietHoaDonDoAn ct JOIN banDoAn da ON ct.maDoAn = da.maDoAn "
                    + "GROUP BY da.tenDoAn";
            ...
            while (rs.next()) {
                ...
                JPanel card = createDoanhThuCard(tenDoAn, soLuong, doanhThu);
    ...
    public void loadDoanhThuCardsByDateRange(LocalDate startDate, LocalDate endDate) {
        try {
            ...
            String sql = "SELECT da.tenDoAn, SUM(ct.soLuong) as soLuong, SUM(ct.soLuong * da.giaDoAn) as doanhThu "
                    + "FROM chiTietHoaDonDoAn ct JOIN banDoAn da ON ct.maDoAn = da.maDoAn "
                    + "JOIN hoaDonDoAn hd ON ct.maHoaDon = hd.maHoaDon ";
            if (startDate != null && endDate != null) {
                sql += "WHERE hd.ngayMua BETWEEN ? AND ? ";
            }
            sql += "GROUP BY da.tenDoAn";
            ...
            // Cập nhật lại các nhãn thống kê (trừ lblThangCaoNhat)
            String sqlTongDoanhThu = "SELECT SUM(tongTien) as tongDoanhThu FROM hoaDonDoAn";
            String sqlTongDoAn = "SELECT SUM(soLuong) as tongDoAn FROM chiTietHoaDonDoAn ct JOIN hoaDonDoAn hd ON ct.maHoaDon = hd.maHoaDon";
            String sqlDoAnNhieuNhat = "SELECT TOP 1 da.tenDoAn, SUM(ct.soLuong) as soLuong "
                    + "FROM chiTietHoaDonDoAn ct JOIN banDoAn da ON ct.maDoAn = da.maDoAn "
                    + "JOIN hoaDonDoAn hd ON ct.maHoaDon = hd.maHoaDon ";
            String sqlDoanhThuTB = "SELECT AVG(tongTien) as doanhThuTB FROM hoaDonDoAn";
            if (startDate != null && endDate != null) {
                ...
                sqlTongDoAn += " WHERE hd.ngayMua BETWEEN ? AND ?";
                sqlDoAnNhieuNhat += " WHERE hd.ngayMua BETWEEN ? AND ? GROUP BY da.tenDoAn ORDER BY soLuong DESC";
            ...
            PreparedStatement pstmtTongDoAn = conn.prepareStatement(sqlTongDoAn);
            if (startDate != null && endDate != null) {
                pstmtTongDoAn.setDate(1, Date.valueOf(startDate));
                pstmtTongDoAn.setDate(2, Date.valueOf(endDate));
            }
            ResultSet rsTongDoAn = pstmtTongDoAn.executeQuery();
            int tongDoAn = rsTongDoAn.next() ? rsTongDoAn.getInt("tongDoAn") : 0;
            lblTongDoAn.setText(String.valueOf(tongDoAn));
            ...
            PreparedStatement pstmtDoAnNhieuNhat = conn.prepareStatement(sqlDoAnNhieuNhat);
            if (startDate != null && endDate != null) {
                pstmtDoAnNhieuNhat.setDate(1, Date.valueOf(startDate));
                pstmtDoAnNhieuNhat.setDate(2, Date.valueOf(endDate));
            }
            ResultSet rsDoAnNhieuNhat = pstmtDoAnNhieuNhat.executeQuery();
            String doAnNhieuNhat = rsDoAnNhieuNhat.next() ? rsDoAnNhieuNhat.getString("tenDoAn") : "Không có";
            lblDoAnNhieuNhat.setText(doAnNhieuNhat);
    ...
    private void initComponents() {
        ...
        lblDoAnNhieuNhat = new javax.swing.JLabel();
        ...
        headerLabel.setText("THỐNG KÊ DOANH THU ĐỒ ĂN");
        ...
        lblTongDoAn.setBackground(new java.awt.Color(240, 240, 240));
        lblTongDoAn.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblTongDoAn.setForeground(new java.awt.Color(0, 153, 255));
        lblTongDoAn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        lblTongDoAn.setOpaque(true);
        ...
        jLabel2.setText("Tổng số lượng đồ ăn bán ra:");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel3.setText("Đồ ăn bán được nhiều nhất:");
        ...
        lblDoAnNhieuNhat.setBackground(new java.awt.Color(240, 240, 240));
        lblDoAnNhieuNhat.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblDoAnNhieuNhat.setForeground(new java.awt.Color(0, 153, 255));
        lblDoAnNhieuNhat.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        lblDoAnNhieuNhat.setOpaque(true);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblDoanhThuTrungBinh, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(66, 66, 66)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lblTongDoAn, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblDoAnNhieuNhat, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3)
                    .addComponent(lblDoAnNhieuNhat, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chiTietDoanhThuDoAn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new chiTietDoanhThuDoAn().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblDoAnNhieuNhat;
