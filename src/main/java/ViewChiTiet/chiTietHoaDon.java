...
public class chiTietHoaDon extends javax.swing.JFrame {
    ...
    private JPanel createHoaDonCard(String maHoaDon, String ngayMua, String tenNhanVien, List<String> chiTietVe, int tongTien) {
    ...
    private void loadHoaDonCards() {
        try {
            ...
            while (rs.next()) {
                ...
                List<String> chiTietVe = new ArrayList<>();
                String chiTietSql = "SELECT v.loaiVe, cthd.soLuong "
                ...
                while (rsChiTiet.next()) {
                    String loaiVe = rsChiTiet.getString("loaiVe");
                    int soLuong = rsChiTiet.getInt("soLuong");
                    chiTietVe.add("    Loại vé: " + loaiVe + " - Số lượng: " + soLuong);
                }

                JPanel card = createHoaDonCard(maHD, ngayMua, tenNV, chiTietVe, tongTien);
    ...
    public void loadNamComboBox() {
        try {
            Connection conn = ConnectDB.getConnection();
            String sql = "SELECT DISTINCT YEAR(ngayMua) AS nam FROM HoaDon ORDER BY nam";
    ...
    private void initComponents() {
        ...
        headerLabel.setText("THỐNG KÊ HÓA ĐƠN");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cboNhanVien, 0, 144, Short.MAX_VALUE)
    ...
    private void btnApDungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApDungActionPerformed
        ...
        try {
            ...
            while (rs.next()) {
                ...
                List<String> chiTietVe = new ArrayList<>();
                String detailSql = "SELECT v.loaiVe, cthd.soLuong FROM ChiTietHoaDon cthd JOIN Ve v ON cthd.maVe = v.maVe WHERE maHoaDon = ?";
                PreparedStatement detailStmt = conn.prepareStatement(detailSql);
                detailStmt.setString(1, maHD);
                ResultSet rsDetail = detailStmt.executeQuery();

                while (rsDetail.next()) {
                    chiTietVe.add("    Loại vé: " + rsDetail.getString("loaiVe")
