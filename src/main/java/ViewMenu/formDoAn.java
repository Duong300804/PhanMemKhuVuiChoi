 ...
 * @author LENOVO
 */
public class formDoAn extends javax.swing.JPanel {

    
    private DefaultTableModel tableModel;
    /**
     * Creates new form formDoAn
     */
    public formDoAn() {
        initComponents();
        tableModel = (DefaultTableModel) tblThongTinDoAn.getModel();
        LoadDuLieuBang();
        SuKienClick();
    }
    
    public void LoadDuLieuBang() {
        try (Connection conn = ConnectDB.getConnection()) {
            String query = "SELECT * FROM banDoAn";
            ...
            Logger.getLogger(formDoAn.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    private void SuKienClick() {
        tblThongTinDoAn.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                int selectedRow = tblThongTinDoAn.getSelectedRow();
                if (selectedRow >= 0) {
                    txtMaDoAn.setText(tableModel.getValueAt(selectedRow, 0).toString());
                    txtTenDoAn.setText(tableModel.getValueAt(selectedRow, 1).toString());
    ...
    private void initComponents() {
        ...
        labelTenDA = new javax.swing.JLabel();
        ...
        headerLabel.setText("QUẢN LÝ ĐỒ ĂN");
        ...
        labelTenDA.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        labelTenDA.setText("Tên đồ ăn:");
        ...
        labelIMG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Res/fast-food (1).png"))); // NOI18N

        labelGia.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        labelGia.setText("Giá: ");

        labelMaDA.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        labelMaDA.setText("Mã đồ ăn:");
                ...
                .addGroup(informationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, informationPanelLayout.createSequentialGroup()
                        .addGroup(informationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(labelTenDA, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(labelSL)
                            .addComponent(labelGia)
                            .addComponent(labelMaDA, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(informationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtMaDoAn, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 289, Short.MAX_VALUE)
                            .addComponent(txtTenDoAn, javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(informationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(informationPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(informationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(labelMaDA, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(informationPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(labelTenDA, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tblThongTinDoAn.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Mã đồ ăn", "Tên đồ ăn", "Giá", "Số lượng"
            }
        ));
        jScrollPane1.setViewportView(tblThongTinDoAn);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (maDoAn.isEmpty() || tenDoAn.isEmpty() || gia.isEmpty() || soLuong.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }

        try {
            float giaDoAn = Float.parseFloat(gia);
            ...
            try (Connection conn = ConnectDB.getConnection()) {
                String checkQuery = "SELECT maDoAn FROM banDoAn WHERE maDoAn = ?";
                PreparedStatement checkStmt = conn.prepareStatement(checkQuery);
                checkStmt.setString(1, maDoAn);
                ResultSet rs = checkStmt.executeQuery();
                if (!rs.next()) {
                    JOptionPane.showMessageDialog(this, "Không được sửa mã đồ ăn!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                String updateQuery = "UPDATE banDoAn SET tenDoAn = ?, giaDoAn = ?, soLuong = ? WHERE maDoAn = ?";
                PreparedStatement updateStmt = conn.prepareStatement(updateQuery);
                updateStmt.setString(1, tenDoAn);
                updateStmt.setFloat(2, giaDoAn);
                updateStmt.setInt(3, sl);
                updateStmt.setString(4, maDoAn);

                int rowsAffected = updateStmt.executeUpdate();
                if (rowsAffected > 0) {
                    JOptionPane.showMessageDialog(this, "Sửa đồ ăn thành công!", "Thành công", JOptionPane.INFORMATION_MESSAGE);
                    LoadDuLieuBang();
                    LamMoiBang();
                }
            } catch (SQLException ex) {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (maDoAn.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập mã đồ ăn!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try (Connection conn = ConnectDB.getConnection()) {
            ...
            ResultSet rs = checkStmt.executeQuery();
            if (!rs.next()) {
                JOptionPane.showMessageDialog(this, "Mã đồ ăn không tồn tại!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }

            String deleteQuery = "DELETE FROM banDoAn WHERE maDoAn = ?";
            PreparedStatement deleteStmt = conn.prepareStatement(deleteQuery);
            deleteStmt.setString(1, maDoAn);
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        try (Connection conn = ConnectDB.getConnection()) {
            String query = "SELECT * FROM banDoAn WHERE CONCAT(tenDoAn, ' ', maDoAn) LIKE ?";
            PreparedStatement stmt = conn.prepareStatement(query);
            ...
            if (!found) {
                JOptionPane.showMessageDialog(this, "Không tìm thấy đồ ăn nào!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                LamMoiBang();
            }
        } catch (SQLException ex) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            ...
            try (Connection conn = ConnectDB.getConnection()) {
                ...
                String insertQuery = "INSERT INTO banDoAn (maDoAn, tenDoAn, giaDoAn, soLuong) VALUES (?, ?, ?, ?)";
                PreparedStatement insertStmt = conn.prepareStatement(insertQuery);
                insertStmt.setString(1, maDoAn);
                insertStmt.setString(2, tenDoAn);
                insertStmt.setFloat(3, giaDoAn);
    ...
    private javax.swing.JLabel labelMaDA;
    private javax.swing.JLabel labelSL;
    private javax.swing.JLabel labelTenDA;
    private javax.swing.JLabel labelTimKiem;
    private javax.swing.JPanel tabelPanel;
    private javax.swing.JTable tblThongTinDoAn;
